...
from einops import rearrange
# from stable_video_infinity.utils.audio_process import get_embedding, audio_prepare_single
# from stable_video_infinity.utils.src.audio_analysis.wav2vec2 import Wav2Vec2Model
